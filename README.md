...
## **What is reBSD?**
 - reBSD is a mini operating system based on FreeBSD custom kernel, which can be used to maintain cloud instances/VPS based on KVM or XEN.
...
**Features?**
 ...
 2. Compatible with dedicated server/KVM/XEN, support UEFI
